...
<div class="wrapper">
	...
	<div class="banner" id="inicio">
		<div class="banner-top container">
			<div class="vertical-align pull-right facebook">
				<a href=""><img src="img/icons/fb.png" alt="facebook"></a>
			</div>
			<div class="vertical-align contact-info">
				<p>
				...
				<div id="carousel-example-generic" class="carousel slide vertical-align" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							...
							<a href="#" class="pull-right">Ver receta</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container text-center">
			...
			<div class="row no-margin">
				...
				<div class="col-sm-4">
					...
					<div class="header-container bg-green"><h2 class="section-header vertical-align">Cortes especiales</h2></div>
					<p class="text">
				...
				<div class="col-sm-4">
					...
					<div class="header-container bg-yellow"><h2 class="section-header vertical-align">Cortes finos</h2></div>
					<p class="text">
	...
	<div class="servicio">
		<div class="parallax-container">
			...
			<div class="container text-center">
				<h1 class="white vertical-align">Servicio al Cliente</h1>
			</div>
		</div>
	</div>
	<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
